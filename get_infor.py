...
def run():
    ...
    for index, i in enumerate(links):
        try:
            print('----------------------------------')
            print('Load link '+str(index+1))
            get_info(i)
            print('Done link '+str(index+1))
            print('----------------------------------')
        except:
            pass
            
            print('-------   Pass link '+str(index+1)+'   --------')


run()

# get_info('https://nhaphonet.vn/tin-dang/ban-nha-mat-pho-phan-ke-binh-kinh-doanh-cuc-hot-via-he-82m-gia-28-5-ty/')